...
import in.sigrid.englishlearning.activity.ProfileActivity;
import in.sigrid.englishlearning.adapter.GameQuestionAdapter;
        ...
        mFabSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nextItem < count) {
                    ...
                    ((ProfileActivity)getActivity()).checkForAchievements("");
                }
            }
        });
                ...
                case 1:
                    ...
                    new CountDownTimer(60000, 1000) {
                        ...
                        public void onTick(long millisUntilFinished) {
                            mProgressBar.setProgress(60-(int)millisUntilFinished/1000);
                            Log.i("Time",""+(60-(int)millisUntilFinished/1000));
                        }
